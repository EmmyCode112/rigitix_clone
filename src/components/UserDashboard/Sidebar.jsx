...
const Sidebar = () => {
  return (
    <div className="flex flex-col w-64 h-screen bg-white border-r sticky top-0">
      <div className="py-2 px-6">
        <img src={rigitixBlueLogo} alt="Logo" />
      </div>

      {/* Main Navigation */}
      <nav className="flex flex-col mt-6 px-2 space-y-5 text">
        <div className="flex items-center bg-[#F87B0733] rounded-md px-4 py-2 cursor-pointer">
          <FontAwesomeIcon icon={faGauge} className="text-[#FE9B51] mr-2" />
          <span className="text-[#FE9B51] font-medium">Dashboard</span>
        </div>
        <div className="flex items-center cursor-pointer px-4 py-3 rounded">
      ...
      {/* Bottom Navigation */}
      <div className="px-6 pb-4 space-y-5 text">
      ...
      <div className="px-4 py-4 border-t flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <div className="max-w-36">
            <p className="font-semibold">Tena Opregha</p>
